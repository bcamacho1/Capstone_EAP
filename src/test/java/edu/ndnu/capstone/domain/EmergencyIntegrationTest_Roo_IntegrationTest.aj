...
import edu.ndnu.capstone.domain.EmergencyIntegrationTest;
...
privileged aspect EmergencyIntegrationTest_Roo_IntegrationTest {
    
    declare @type: EmergencyIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: EmergencyIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: EmergencyIntegrationTest: @Transactional;
    
    @Autowired
    EmergencyDataOnDemand EmergencyIntegrationTest.dod;
    
    @Autowired
    EmergencyService EmergencyIntegrationTest.emergencyService;
    
    @Test
    public void EmergencyIntegrationTest.testCountAllEmergencys() {
    ...
    @Test
    public void EmergencyIntegrationTest.testFindEmergency() {
    ...
    @Test
    public void EmergencyIntegrationTest.testFindAllEmergencys() {
        Assert.assertNotNull("Data on demand for 'Emergency' failed to initialize correctly", dod.getRandomEmergency());
        long count = emergencyService.countAllEmergencys();
    ...
    @Test
    public void EmergencyIntegrationTest.testFindEmergencyEntries() {
        Assert.assertNotNull("Data on demand for 'Emergency' failed to initialize correctly", dod.getRandomEmergency());
        long count = emergencyService.countAllEmergencys();
    ...
    @Test
    public void EmergencyIntegrationTest.testSaveEmergency() {
        Assert.assertNotNull("Data on demand for 'Emergency' failed to initialize correctly", dod.getRandomEmergency());
    ...
    @Test
    public void EmergencyIntegrationTest.testDeleteEmergency() {
        Emergency obj = dod.getRandomEmergency();
        Assert.assertNotNull("Data on demand for 'Emergency' failed to initialize correctly", obj);
        Integer id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Emergency' failed to provide an identifier", id);

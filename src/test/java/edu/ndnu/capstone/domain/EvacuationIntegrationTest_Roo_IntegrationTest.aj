...
privileged aspect EvacuationIntegrationTest_Roo_IntegrationTest {
    
    declare @type: EvacuationIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: EvacuationIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: EvacuationIntegrationTest: @Transactional;
    
    @Autowired
    EvacuationDataOnDemand EvacuationIntegrationTest.dod;
    
    @Autowired
    EvacuationService EvacuationIntegrationTest.evacuationService;
    
    @Test
    public void EvacuationIntegrationTest.testCountAllEvacuations() {
    ...
    @Test
    public void EvacuationIntegrationTest.testFindEvacuation() {
    ...
    @Test
    public void EvacuationIntegrationTest.testFindAllEvacuations() {
        Assert.assertNotNull("Data on demand for 'Evacuation' failed to initialize correctly", dod.getRandomEvacuation());
        long count = evacuationService.countAllEvacuations();
    ...
    @Test
    public void EvacuationIntegrationTest.testFindEvacuationEntries() {
        Assert.assertNotNull("Data on demand for 'Evacuation' failed to initialize correctly", dod.getRandomEvacuation());
        long count = evacuationService.countAllEvacuations();
    ...
    @Test
    public void EvacuationIntegrationTest.testSaveEvacuation() {
        Assert.assertNotNull("Data on demand for 'Evacuation' failed to initialize correctly", dod.getRandomEvacuation());
    ...
    @Test
    public void EvacuationIntegrationTest.testDeleteEvacuation() {
        Evacuation obj = dod.getRandomEvacuation();
        Assert.assertNotNull("Data on demand for 'Evacuation' failed to initialize correctly", obj);
        Integer id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Evacuation' failed to provide an identifier", id);
